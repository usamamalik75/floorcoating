...
export const SITE_VISIT_RESPONSES: SiteVisitResponse[] = [
  {
    ...
    requests: [
      {
        id: 'req_mw_1',
        serviceType: 'Facility cleaning and equipment service',
        concernOrOutcome: 'Restore washdown-safe floor in process rooms',
        quantity: 6180,
        unit: 'sq ft',
        areaOrEquipment: 'Process rooms 301–305',
      },
      {
        id: 'req_mw_2',
        serviceType: 'Facility cleaning and equipment service',
        concernOrOutcome: 'Packaging hall coating to match process rooms',
        quantity: 2450,
        unit: 'sq ft',
        areaOrEquipment: 'Packaging hall 310',
      },
      {
        id: 'req_mw_3',
        serviceType: 'Heavy-build wash bay service',
        concernOrOutcome: 'Thicker build with quartz for wash bay abuse',
        quantity: 770,
        unit: 'sq ft',
        areaOrEquipment: 'Wash bay 308',
      },
    ],
    values: {
      existing_condition: 'Quarry tile with minor spalling near filler line 3',
      utilities: 'Customer-provided power and water are available during the service window',
      condition_photo: true,
  ...
  },
  {
    ...
    requests: [
      {
        id: 'req_lb_1',
        serviceType: 'Brewhouse floor coating',
        concernOrOutcome: 'Thermal shock and caustic resistance',
        quantity: 2400,
        unit: 'sq ft',
        areaOrEquipment: 'Brewhouse floor',
      },
      {
        id: 'req_lb_2',
        serviceType: 'Keg wash pit lining',
        concernOrOutcome: 'Contain wash chemicals; confined-space work',
        quantity: 800,
        unit: 'sq ft',
        areaOrEquipment: 'Keg wash pit',
      },
    ],
    values: {
      existing_condition: 'Sealed site — sound substrate',
      utilities: 'Power and water available Mondays when closed',
      condition_photo: true,
      ...
      access: 'Brite tanks stay. Keg washer to be isolated by brewery staff.',
    ...
    requests: [
      {
        ...
        concernOrOutcome: 'Cosmetic refresh and oil resistance',
        quantity: 720,
        unit: 'sq ft',
        areaOrEquipment: '3-car garage',
      },
    ],
    values: {
      access: 'Park on street; side door from driveway',
      utilities: true,
      hazards: 'Low ceiling near HVAC unit; pets in home',
...
export const CHECKLIST_INSTANCES: ChecklistInstance[] = [
  ...
  {
    id: 'ci_6',
    templateId: 'cl_sales_call_residential',
    opportunityId: 'op_hartley_hvac',
    items: [
  ...
  {
    id: 'ci_7',
    templateId: 'cl_site_visit_industrial',
    opportunityId: 'op_midwest_plant3',
    items: [
    ...
    done: ['isc1', 'isc2', 'isc3', 'isc4', 'isc5', 'isc6', 'isc7', 'isc8', 'isc9'],
    completedAt: iso(-6, 16),
  },
]
